...
export const LOCATIONS: Location[] = [
  ...
  "Computers", "Whiteboard"],
    hourNotes: "The prototyping studio is open during 9am to 5pm on weekdays when the college is open, and during student staffed Open Hours: \n  https://www.smith.edu/academics/design-thinking/studio#hours \nYou may gain OneCard access to Design Thinking Initiative from 6 am to 1 am after completing our Safety Training Quiz: \n  https://www.smith.edu/academics/design-thinking/studio/safety-training",
